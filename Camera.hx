...
class Camera{
	...
	public function new(){
		viewport = new Rectangle(0, 0, Manager.engine.width, Manager.engine.height);
	...
	public function update(){
		...
		//			this.viewport.x = followObject.x - (Manager.engine.width / 2);
		//			this.viewport.y = followObject.y - (Manager.engine.height / 2);
		//		}
		//	}else{
		//		this.viewport.x = followObject.x - (Manager.engine.width / 2);
		//		this.viewport.y = followObject.y - (Manager.engine.height / 2);
